...
def seed_demo_data():
    ...
    profiles = [
        (
            "Alice Chen",
            "Recent grad from Berkeley, love hiking and exploring new coffee shops!",
            "San Francisco",
            "hiking,coffee,reading,music",
            "coffee,hiking,concerts,bookstores",
            "weekends",
        ),
        (
            "Bob Martinez",
            "Just moved to SF for work. Avid hiker and music festival enthusiast.",
            "San Francisco",
            "hiking,music,photography,travel",
            "hiking,concerts,photography,travel",
            "both",
        ),
        (
            "Charlie Kim",
            "Tech professional who loves cooking and trying new restaurants.",
            "Oakland",
            "cooking,food,tech,gaming",
            "cooking,restaurants,movies,gaming",
            "weekdays",
        ),
        (
            "Diana Patel",
            "Yoga instructor and outdoor adventure lover. Always down for a hike!",
            "San Francisco",
            "yoga,hiking,wellness,nature",
            "hiking,yoga,meditation,nature-walks",
            "weekends",
        ),
        (
            "Evan Torres",
            "Coffee enthusiast and bookworm. Looking for reading buddies!",
            "Berkeley",
            "reading,coffee,writing,art",
            "coffee,bookstores,museums,writing-groups",
            "both",
        ),
    ]
