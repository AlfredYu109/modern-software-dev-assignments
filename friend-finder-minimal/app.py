...
def create_profile():
    ...
    ''', (
        ...
        ','.join(data.get('activities', [])) if isinstance(data.get('activities'), list) else data.get('activities', ''),
...
def delete_profile(profile_id):
    ...
    cursor.execute('DELETE FROM connections WHERE sender_id = ? OR receiver_id = ?', (profile_id, profile_id))
...
def get_matches(profile_id):
    ...
    user_interests = set(filter(None, user_profile['interests'].split(','))) if user_profile['interests'] else set()
    user_activities = set(filter(None, user_profile['activities'].split(','))) if user_profile['activities'] else set()
    ...
    for profile in all_profiles:
        profile_interests = set(filter(None, profile['interests'].split(','))) if profile['interests'] else set()
        profile_activities = set(filter(None, profile['activities'].split(','))) if profile['activities'] else set()
